...
def switchMenu(choice):
    ...
    if choice == '9':
        extrasMenu()
    if choice == '0':
        sys.exit("Exiting Socterminal... done")
    else:
        mainMenu()
...
def unshortenUrl():
    ...
    table = Table()
    table.add_column("Original URL",style="magenta")
    table.add_column("Unshortened URL", style="green")
    table.add_row(link, req.text)

    console.print(table)
    pyperclip.copy(req.text)
    console.print("Unshortened link copied to clipboard!", style="yellow")
    press_any_key()
    decoderMenu()
...
def extrasMenu():
    ...
    print("+{:-^62}+".format(""))
    print("|{:<62}|".format("What would you like to do?"))
    print("|{:<62}|".format("OPTION 1: About Socterminal"))
...
def wikiLink():
    print('\n The Socterminal Wiki can be found at the following link:')
    print(' https://github.com/akshay-nehate/Socterminal/wiki')
    extrasMenu()

def ghLink():
    print('\n The Socterminal Repo can be found at the following link:')
    print(' https://github.com/akshay-nehate/Socterminal')
    extrasMenu()
